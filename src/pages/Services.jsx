        ...
        <div className="container">
          ...
          <div className="grid-2">
            ...
            <div style={{ position: 'relative', margin: '0 10px 40px 10px', transform: 'rotate(2deg)' }}>
               <div style={{ position: 'absolute', top: 10, left: 10, right: -10, bottom: -10, backgroundColor: '#000' }} />
               <div style={{ backgroundColor: 'var(--color-pink)', border: 'var(--border-width) solid #000', padding: '20px', paddingBottom: '40px', height: '100%', position: 'relative' }}>
                  
                  <div style={{ backgroundColor: '#fff', border: 'var(--border-width) solid #000', padding: '15px', height: '140px', zIndex: 2, position: 'relative' }}>
                  ...
                  <div style={{ position: 'absolute', top: '-3px', right: '20px', width: '80px', height: '60px', backgroundColor: '#e0e0e0', border: 'var(--border-width) solid #000', zIndex: 1 }}>
                  ...
                  <a href="#" className="btn" style={{ position: 'absolute', bottom: '-20px', left: '50%', transform: 'translateX(-50%) rotate(-4deg)', backgroundColor: 'var(--color-lime)', padding: '15px 30px', zIndex: 3, boxShadow: '4px 4px 0 #000' }}>
                     PULL DATA
                  </a>
               </div>
            </div>
